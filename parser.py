...
def get_source_html(url):
    driver = webdriver.Chrome(
        executable_path="/Projects/Python/Git/Parser_order/chromedriver/chromedriver.exe"
    )
    ...
    try:
        ...
        while True:
            ...
            if driver.find_elements_by_class_name("hasmore-text"):
                with open("parser_detail.html", "w", encoding="utf-8") as file:
...
def main():
    ...
    # print(get_items_urls(file_path="\Projects\Python\Git\parser_order\parser_detail.html"))
    print(get_data(file_path="\Projects\Python\Git\parser_order\items_urls.txt"))
